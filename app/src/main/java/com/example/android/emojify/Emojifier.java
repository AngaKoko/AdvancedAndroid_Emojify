...
class Emojifier {
    ...
    /**
     * Combines the original picture with the emoji bitmap
    ...
    public static Bitmap addBitmapToFace(Bitmap backgroundBitmap, Bitmap emojiBitmap, Face face){
        ...
        //Scale emoji so it looks better on face
        ...
        float emojiPositionY = (face.getPosition().y + face.getHeight()/2) - emojiBitmap.getHeight()/2;
